/**
 * Videos Page - User Video Posts
 * 회원 동영상 게시판 (Gallery와 동일한 구조)
 */
...
export default function VideosPage() {
  ...
  useEffect(() => {
    ...
    const handleLoginEvent = () => {
      console.log('🔔 Login event received in Videos - reloading user');
      loadUser();
    };
  ...
  const loadUser = () => {
    ...
    console.log('🔐 Videos - localStorage user:', currentUser);
    setUser(currentUser);
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex flex-col sm:flex-row gap-4 items-center justify-between">
          ...
          {user ? (
            ...
            <Link href="/auth/login?redirect=/videos/new">
